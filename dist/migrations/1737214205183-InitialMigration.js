...
exports.InitialMigration1737214205183 = void 0;
class InitialMigration1737214205183 {
    constructor() {
        this.name = 'InitialMigration1737214205183';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "car" ("created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP DEFAULT now(), "deleted_date" TIMESTAMP, "id" SERIAL NOT NULL, "model" character varying NOT NULL, "year" character varying NOT NULL, "rentPerDay" integer NOT NULL, "manufacture" character varying, "capacity" integer NOT NULL, "transmission" character varying NOT NULL, "withDriver" boolean NOT NULL, "imagePublicId" character varying NOT NULL, "imageURL" character varying NOT NULL, "startRent" TIMESTAMP, "endRent" TIMESTAMP, "description" text, "creatorId" integer, "updaterId" integer, "deleterId" integer, CONSTRAINT "PK_55bbdeb14e0b1d7ab417d11ee6d" PRIMARY KEY ("id"))`);
...
exports.InitialMigration1737214205183 = InitialMigration1737214205183;
