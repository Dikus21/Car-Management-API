...
async function carSeeder() {
    ...
    const carEntities = await Promise.all(cars.map(async (car) => {
        const filePath = path_1.default.resolve(__dirname, "../../public/assets/uploads", car.image);
        console.log(filePath);
        const result = await (0, cloudinaryUpload_1.uploadToCloudinary)(filePath);
    ...
    await Database_1.default.manager.save(carEntities);
