...
export class InitialMigration1717319515110 implements MigrationInterface {
    name = 'InitialMigration1717319515110'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "car" ("created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP DEFAULT now(), "deleted_date" TIMESTAMP, "id" SERIAL NOT NULL, "model" character varying NOT NULL, "year" character varying NOT NULL, "price" character varying NOT NULL, "image" character varying NOT NULL, "creatorId" integer, "updaterId" integer, "deleterId" integer, CONSTRAINT "PK_55bbdeb14e0b1d7ab417d11ee6d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP DEFAULT now(), "deleted_date" TIMESTAMP, "id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "role" character varying NOT NULL, "refreshToken" character varying NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
